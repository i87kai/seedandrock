...
namespace SeedAndRock.UI
{
    ...
    public sealed class SurvivalStatusHud : MonoBehaviour
    {
        ...
        private void Build()
        {
            ...
            root.sizeDelta = new Vector2(336f, 248f);
            ...
            bodyTemperatureLabel = CreateLabel(root, "BodyTemperature", 34f, pale, FontStyles.Bold, TextAlignmentOptions.MidlineRight, new Vector2(0f, 40f));
            airTemperatureLabel = CreateLabel(root, "AirTemperature", 15f, muted, FontStyles.Normal, TextAlignmentOptions.MidlineRight, new Vector2(0f, 22f));
        ...
        {
            GameObject row = CreateRow(parent, name + "Row", 28f);
            ...
            TMP_Text label = CreateLabel(row.transform, "Label", 13f, muted, FontStyles.Bold, TextAlignmentOptions.MidlineLeft, new Vector2(70f, 28f));
            label.text = caption;
            ...
            value = CreateLabel(row.transform, "Value", 13f, pale, FontStyles.Bold, TextAlignmentOptions.MidlineRight, new Vector2(48f, 28f));
